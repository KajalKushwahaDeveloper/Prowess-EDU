    ...
    <Router>
      <Routes>
        ...
        >
          ...
          {/* Nested routes */}
          <Route
            path="studentDashboardVideos"
            element={<StudentDashboardVideos />}
          />
        ...
        >
          ...
          {/* Nested routes */}
          <Route
            path="teacherDashboardStudents"
            element={<TeacherDashboardStudents />}
          />
          <Route
            path="teacherDashboardVideos"
            element={<TeacherDashboardVideos />}
          />
          <Route
            path="teacherDashboardAssignment"
            element={<TeacherDashboardAssignment />}
          />
          <Route
            path="teacherDashboardOnlineClass"
            element={<TeacherDashboardOnlineClass />}
          />
          <Route
            path="teacherDashboardTimeTable"
            element={<TeacherDashboardTimeTable />}
          />
